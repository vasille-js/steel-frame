...
class FakeRunner implements Runner<unknown, unknown, object> {
  ...
  textNode(
    text: unknown,
  ): TextNode<unknown, unknown, object, Runner<unknown, unknown, object>> {
    throw new Error("Method not implemented.");
  }
  tag(
    tagName: string,
    ...
    cb?:
      | ((
          ctx: Tag<unknown, unknown, object, Runner<unknown, unknown, object>>,
        ) => void)
      | undefined,
  ): Tag<unknown, unknown, object, Runner<unknown, unknown, object>> {
    throw new Error("Method not implemented.");
  }
}
